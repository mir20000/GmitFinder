...
function CDCAchievementAction(props) {

    const [orderArray,setOrderArray]=useState()

    function handleLoad(){
                Axios.post('http://localhost:4555/getallachievement',{                                                                             
                }).then((response)=>{                       
    ...
    function handleApprove(params) {
        Axios.post('http://localhost:4555/setflagachievement',{ 
            id:params,
            flag:true                                                                            
        }).then((response)=>{                       
...
export default CDCAchievementAction;